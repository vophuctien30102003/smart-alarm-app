...
export default function SearchLocation({
  ...
  const handleLocationSelect = useCallback(
    async (data: GooglePlaceData, details: GooglePlaceDetails | null = null) => {
      try {
    ...
    [onLocationSelect, onError, saveToStore, setPreviewLocation, setSelectedLocation]
  );
  ...
  return (
    <View className="flex-1 z-10">
      <GooglePlacesAutocomplete
        ...
        enablePoweredByContainer={false} // tắt "Powered by Google" nếu bạn muốn gọn
        listEmptyComponent={() => (
          <View className="p-4">
